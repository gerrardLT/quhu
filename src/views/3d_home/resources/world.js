...
import galaxyVertexShader from '@/assets/jsm/vertex.glsl';
import galaxyFragmentShader from '@/assets/jsm/fragment.glsl';
...
export function addParticles() {
  ...
  // 生成顶点数据
  var vertices = new Float32Array(3000 * 3); // 每个顶点有 3 个坐标值

  for (let i = 0; i < vertices.length; i += 3) {
    vertices[i] = getRandomArbitrary(-1100, 1100);
    vertices[i + 1] = getRandomArbitrary(-1100, 1100);
    vertices[i + 2] = getRandomArbitrary(-1100, -500);
  }
  ...
  // 使用 BufferGeometry 创建 Points 对象
